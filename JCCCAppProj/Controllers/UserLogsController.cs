...
namespace JCCCAppProj.Controllers
{
    public class UserLogsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserLogID,LastLoginDate,LastApplyDate")] UserLog userLog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserLogID,LastLoginDate,LastApplyDate")] UserLog userLog)
        {
            if (ModelState.IsValid)
            {
